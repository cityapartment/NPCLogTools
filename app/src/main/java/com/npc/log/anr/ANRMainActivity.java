...
public class ANRMainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.anr_main_layout);

        final ZacWatchdogUtils application = ZacWatchdogUtils.getInstance();
        ...
        minAnrDurationButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                MainHandlerFactory.getInstance().saveBehaviorEvent();
